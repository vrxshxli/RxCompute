...
export default function PharmacistDashboard() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/dashboard/pharmacist`, {
  ...
  const role = data?.role || 'pharmacist';

  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      <DashboardHeader title="Pharmacist Dashboard" role={role} />
      <main className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="col-span-2 bg-white rounded-xl shadow border border-gray-100 p-6">
            <h2 className="text-lg font-semibold mb-2">Dispensing Overview</h2>
