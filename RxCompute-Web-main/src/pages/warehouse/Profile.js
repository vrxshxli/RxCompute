...
export default function WarehouseProfile() {
  ...
  return (
    <div>
      <PageHeader title="Warehouse Profile" subtitle="Manage your details and warehouse location" />
      <div style={{ background: T.white, border: `1px solid ${T.gray200}`, borderRadius: 12, padding: 18, maxWidth: 900 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          ...
          <input value={form.location_text} onChange={(e) => setForm({ ...form, location_text: e.target.value })} placeholder="Warehouse address" style={{ padding: 10, border: `1px solid ${T.gray200}`, borderRadius: 8, gridColumn: "span 2" }} />
